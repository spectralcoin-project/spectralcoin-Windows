...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Spectralcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"spectralcointools.com", "spectralcoin.gotdns.ch"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"spectralcointools.com", "testnet-seed.spectralcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Spectralcoin is probably already running."), addrBind.ToString().c_str());
        else
